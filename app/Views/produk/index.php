...
<script src="<?= base_url() ; ?>/ajax/ajaxProduk.js">
</script>
        ...
        <div class="box-body">
            <table class="table table-striped table-hover" id="mytable">
                <thead>
                    ...
                    <th class="text-align: center;">Gambar Produk</th>
                    <th class="text-align: center;">Nama Produk</th>
                    <th class="text-align: center;">Harga</th>
                    <th class="text-align: center;">Kategori</th>
                    <th class="text-align: center;">Deskripsi</th>
